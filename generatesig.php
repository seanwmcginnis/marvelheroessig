...
/*
 * generatesig.php: This is the module that renders the image.  The output is a PNG file.
 */
...
if(!isset($ref))
{
    die("Hotlinking not permitted: " . $ref);
}
if(strpos($ref, 'marvelheroes.com') !== FALSE)
{
    die("Hotlinking not permitted: " . $ref);
}
/*$refData = parse_url($ref);

if($refData['host'] !== 'seanwmcginnis.com') {
